...
def restore(sigma, u, v, K):  # 奇异值、左特征向量、右特征向量、恢复奇异值的数量
    # 原始图像的大小(m*n) 512 512
    m = u.shape[0]
    n = v.shape[0]
...
if __name__ == "__main__":
    ...
    # 图片对象 <PIL.JpegImagePlugin.JpegImageFile image mode=RGB size=512x512 at 0x153D291C6D8>
    # print(A)
    ...
    # figsize 以dpi为单位的设置显示图像大小，一般8左右比较合适，可以根据需要设置大小
